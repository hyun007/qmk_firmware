...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
        ...
        KC_LCTL, KC_LALT,KC_LGUI,          KC_SPC,                      KC_RCTL,KC_RALT,FNM,    KC_LEFT,KC_DOWN,KC_RGHT
    ),
    /* Colemak Layer
   * ,--------------------------------------------------------------------------------------------------.
   * | Esc |  1  |  2  |  3  |  4  |  5  |  6  |  7  |  8  |  9  |  0  |  -  |  =  | Backspace |  | `   |
  ...
  [_FNM] = LAYOUT(
        ...
        _______,_______,_______,_______,_______,_______,_______,_______,KC_END, KC_PGDN,_______,KC_BTN1,     KC_PGUP,
