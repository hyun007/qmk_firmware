...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                    KC_RALT, KC_RALT, MO(FUNC), KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
  ...
  [_FN] = LAYOUT_65_ansi(
    ...
    MU_MOD,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MU_TOG, \
    AU_TOG,  KC_FN1,  KC_FN3,  _______, _______, _______, _______, _______, _______, _______, _______, _______,          RESET,   KC_VOLU, \
    KC_FN5,  KC_FN2,  KC_FN4,  _______, _______, _______, _______, MU_TOG,  RGB_VAD, RGB_VAI, _______, _______,          RGB_HUI, KC_VOLD, \
    _______, _______, _______,                            _______,                   _______, _______, _______, KC_HOME, RGB_HUD, KC_END  \
  )
};
